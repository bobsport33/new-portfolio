...
const Hero = () => {
  ...
  useLayoutEffect(() => {
    mm.add(
      ...
      (context) => {
        let { isDesktop, isTablet, isSmallTab, isMobile } = context.conditions!;
        ...
        const ctx = gsap.context((self: any) => {
          ...
          tl.fromTo(
            text1,
            { scale: isDesktop ? 2.5 : isTablet ? 2 : 1.85 },
            { scale: 1 }
          )
            .to(text1Other, {
              opacity: 0,
            ...
            .to(text1, {
              x: isDesktop ? -150 : isTablet ? -132 : isSmallTab ? -102 : -70,
            })
            .fromTo(
              textCont2,
              { y: "30%", opacity: 0 },
            ...
            .to(text1, {
              x: isDesktop ? -160 : isTablet ? -138 : isSmallTab ? -106 : -73,
            })
            .fromTo(
              textCont3,
              { y: "30%", opacity: 0 },
            ...
            .to(text1, {
              x: isDesktop ? 33 : isTablet ? 28 : isSmallTab ? 22 : 15,
            })
            .fromTo(
              textCont4,
              { y: "30%", opacity: 0 },
      ...
      <div className="container">
        ...
        <div className="text-container text-container--2">
          <h2 className={"hero__text hero__text--2"}>
            <span className={"hero__span"}>Bob</span> creates stunning projects.
          </h2>
        </div>
        <div className="text-container text-container--3">
          <h2 className={"hero__text hero__text--3"}>
            <span className={"hero__span"}>Bob</span> can build your next
            project.
          </h2>
        </div>
        <div className="text-container text-container--4">
          <h2 className={"hero__text hero__text--4"}>
            See what <span className={"hero__span"}>Bob</span> can do for you.
          </h2>
        </div>
      </div>
    </HeroCont>
